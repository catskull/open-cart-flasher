...
#Pirate MBC% Cart Menu
        PirateMBC5Menu = Menu(menu)
        cartTypeMenu.add_cascade(label="Pirate MBC5",menu=PirateMBC5Menu)
        PirateMBC5Menu.add_command(label='Erase',command=main_PirateMBC5_Erase)
        PirateMBC5Menu.add_command(label='Flash ROM',command=main_PirateMBC5_Write)
...
def main_PirateMBC5_Write():
    main_LoadROM()
    print('Writing ROM Data') 
    main_PirateMBC5_Erase()
    ROMpos=0
    waitcount=0
    for BankNumber in range (0,int((ROMsize/16384))):
        main_ROMBankSwitch(BankNumber) #Set the bank
